package com.sourcepointccpa.app.database;
...
@Database(entities = {Property.class, TargetingParam.class}, version = 1, exportSchema = false)
public abstract class AppDataBase extends RoomDatabase {

    private static AppDataBase sInstance;

    private static final String DATABASE_NAME = "SourcePointCCPADB.db";
