...
import com.sourcepointccpa.app.adapters.PropertyListAdapter;
...
import com.sourcepointccpa.app.viewmodel.PropertyListViewModel;
...
public class PropertyListActivity extends BaseActivity<PropertyListViewModel> {
    ...
    private void showAlertDialogForCookiesCleared(Property property) {
        ...
        cookieConfirmation.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD),12,26, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        cookieConfirmation.setSpan(new RelativeSizeSpan(1.2f),12,26, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
